...
public class UploadActivity extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadTopic, uploadDesc, uploadLang , uploadPrice;
    String imageURL;
    Uri uri;
    ...
    public void uploadData(){
        ...
        ProductClass productClass = new ProductClass( title, desc, lang, imageURL,price);
        ...
        FirebaseDatabase.getInstance().getReference("PRODUCTS").child(currentDate)
                .setValue(productClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
